...
- **Enhanced Excerpts**: Automatically generate AI-powered summaries for your pages, posts, and other content types.  
...
- This plugin requires an API key from one of the supported AI platforms (OpenAI, NVIDIA, Anthropic, DeepSeek, Mistral, Google, or Local) to function. Without an API key, the plugin cannot process summaries.
...
- Obtain API keys here:
    ...
    - [Local API Keys](https://www.jan.ai/docs/desktop/api-server)
...
- [API/Mistral Settings](api-settings/api-mistral-settings.md)

- [API/Google Settings](api-settings/api-google-settings.md)
